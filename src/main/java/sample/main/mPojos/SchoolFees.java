...
public final  class SchoolFees {
    ...
    /**
     *  Defining the Fee object or class to be used
     ...
     */
    public SchoolFees (String feeName, String feeAmoount, String whoPays, String feesDatePeriod, String feesPeriodName,String feesAccountNoumber,String feesDescription ,boolean isSelected) {
     ...
     * @param isSelected    This is for home keeping or the table definition properties
     */
    public SchoolFees (String feeName, String feesPeriodName, String feespaidBy, String feesPayedOnDate, String fromWhoseAccount, String paidAmount, String studentPaying, String paymentMethod, boolean isSelected) {
        this.feeName = feeName;
        this.feesPeriodName = feesPeriodName;
        this.isSelected = isSelected;
